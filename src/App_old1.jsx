    ...
    <div style={s.app} data-testid="app-container">
      <div style={s.sidebar} data-testid="sidebar" id="sidebar" role="navigation" aria-label="Main Navigation">
        ...
        <nav style={s.sidebarNav} data-testid="sidebar-nav">
          ...
          <div style={s.navItem(page === "enrollment")} onClick={() => setPage("enrollment")} data-testid="nav-enrollment" id="nav-enrollment" role="button" aria-label="Families / Groups" aria-current={page === "enrollment" ? "page" : undefined}><span style={s.navIcon}>👨‍👩‍👧‍👦</span> Families / Groups</div>
          <div style={s.navSec}>Claims</div>
          <div style={s.navItem(page === "claims-submit")} onClick={() => setPage("claims-submit")} data-testid="nav-claims-submit" id="nav-claims-submit" role="button" aria-label="Health Facility Claims" aria-current={page === "claims-submit" ? "page" : undefined}><span style={s.navIcon}>🏥</span> Health Facility Claims</div>
